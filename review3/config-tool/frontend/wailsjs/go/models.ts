...
export namespace realtime {
	...
	export class DashboardWidget {
	    ...
	    static createFrom(source: any = {}) {
	        return new DashboardWidget(source);
	    }
	...
	export class DashboardPage {
	    ...
	    static createFrom(source: any = {}) {
	        return new DashboardPage(source);
	    }
	...
	export class InstanceOrigin {
	    ...
	    static createFrom(source: any = {}) {
	        return new InstanceOrigin(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.replicaIndex = source["replicaIndex"];
	        this.originalName = source["originalName"];
	    }
	}
	export class DuplicateInstance {
	    name: string;
	    occurrences: InstanceOrigin[];
	
	    static createFrom(source: any = {}) {
	        return new DuplicateInstance(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.name = source["name"];
	        this.occurrences = this.convertValues(source["occurrences"], InstanceOrigin);
	    }
	...
	export class ExpandedInstance {
	    ...
	    static createFrom(source: any = {}) {
	        return new ExpandedInstance(source);
	    }
	...
	export class ValidationResult {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.valid = source["valid"];
	        this.instances = this.convertValues(source["instances"], ExpandedInstance);
	        this.duplicates = this.convertValues(source["duplicates"], DuplicateInstance);
	    }
