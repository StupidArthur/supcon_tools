...
export function AddExitListener(arg1) {
  return window['go']['bindings']['SystemBinding']['AddExitListener'](arg1);
}
...
export function SetCommandFactoryForTest(arg1) {
  return window['go']['bindings']['SystemBinding']['SetCommandFactoryForTest'](arg1);
}
...
export function SetDataFactoryPathForTest(arg1) {
  return window['go']['bindings']['SystemBinding']['SetDataFactoryPathForTest'](arg1);
}

export function SetReadinessCheckerForTest(arg1) {
  return window['go']['bindings']['SystemBinding']['SetReadinessCheckerForTest'](arg1);
}

export function SetReadyPollIntervalForTest(arg1) {
  return window['go']['bindings']['SystemBinding']['SetReadyPollIntervalForTest'](arg1);
}

export function SetReadyTimeoutForTest(arg1) {
  return window['go']['bindings']['SystemBinding']['SetReadyTimeoutForTest'](arg1);
}
