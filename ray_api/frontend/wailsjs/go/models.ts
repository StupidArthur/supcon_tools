...
export namespace model {
	...
	export class Overview {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.cluster = this.convertValues(source["cluster"], ClusterMetric);
	        this.nodes = this.convertValues(source["nodes"], NodeMetric);
	        this.nodeCount = source["nodeCount"];
	        this.recentJobs = this.convertValues(source["recentJobs"], JobSnapshot);
	        this.updatedAt = source["updatedAt"];
	    }
